...
In 2018, I returned to Bath, England, after spending a year in Canada. After exploring various opportunities, I accepted a position at a small creative agency in Bath called Ready, which had a team of just 11 people. I quickly built a positive working relationship with the owners, and they soon asked me to manage the two engineers we were planning to hire. Having mentored engineers in the past, I felt ready to take on the challenge of management. It probably helped that one of the hires was someone I had worked with before (shout out to Anthony).

I’ve always believed that I have strong people skills and the ability to explain technical concepts to non-technical audiences. My passion for processes and coding standards, areas where the engineering team had limited experience, likely set me apart as a candidate for management. I was grateful for the opportunity.
